...
import type { ToolDefinition, BaseLanguageModelCallOptions, BaseLanguageModelInput } from "@langchain/core/language_models/base";
...
import { BedrockToolChoice, ConverseCommandParams, CredentialType } from "./types.js";
/**
...
export interface ChatBedrockConverseCallOptions extends BaseLanguageModelCallOptions, Pick<ChatBedrockConverseInput, "additionalModelRequestFields" | "streamUsage"> {
    /**
...
export declare class ChatBedrockConverse extends BaseChatModel<ChatBedrockConverseCallOptions, AIMessageChunk> implements ChatBedrockConverseInput {
    ...
    bindTools(tools: (StructuredToolInterface | BedrockTool | ToolDefinition | Record<string, any>)[], kwargs?: Partial<this["ParsedCallOptions"]>): Runnable<BaseLanguageModelInput, AIMessageChunk, this["ParsedCallOptions"]>;
    _llmType(): string;
