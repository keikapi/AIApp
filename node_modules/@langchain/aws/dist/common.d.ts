...
export declare function convertToConverseTools(tools: (StructuredToolInterface | ToolDefinition | BedrockTool | Record<string, any>)[]): BedrockTool[];
export declare function convertToBedrockToolChoice(toolChoice: string | BedrockToolChoice, tools: BedrockTool[]): BedrockToolChoice;
